  ...
  <div class="payment-page">
    <div class="max-w-4xl mx-auto p-6">
      ...
      <div v-if="loading" class="flex flex-col items-center justify-center py-12">
        <UIcon name="i-heroicons-arrow-path" class="animate-spin w-12 h-12 mb-4" />
      ...
      <div v-else-if="redirecting" class="flex flex-col items-center justify-center py-12">
        <UIcon name="i-heroicons-arrow-path" class="animate-spin w-12 h-12 mb-4" />
...
console.log('Payment page data:', { orderId, amount, description })
...
onMounted(async () => {
  console.log('Payment page mounted with:', { orderId, amount, description, user: useAuthStore().currentUser?.uid })
  await createPayment()
})
...
const createPayment = async () => {
  try {
    ...
    const result = await createPayment({
      ...
      currency: 'RUB',
      description,
      returnUrl: `${window.location.origin}/shop/success?orderId=${orderId}`,
